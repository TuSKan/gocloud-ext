...
//
// This file is a verbatim copy of gocloud.dev/internal/escape as of
// github.com/google/go-cloud commit b5401c07b5f16ea9b5902e159ecc6e8a7c3dc498.
// It is vendored because gocloud.dev/internal is, by Go's rules, unreachable
// from outside that module.
//
// Keep it in sync. The escaping is not frozen upstream — commit 03617260
// ("internal/escape: make HexEscape injective against pre-existing escape
// sequences") changed its semantics after v0.46.0 — and drivers here promise
// that their keys and .attrs sidecars interoperate with fileblob and sftpblob.
// Silent drift breaks that promise; escape_test.go pins the current behavior
// so a re-sync shows up as a diff rather than as corrupted keys.
package escape
